...
// let htmlWidth=document.documentElement.clientWidth || document.body.clientHeight;
// console.log(htmlWidth)

// let htmlDom=document.getElementsByTagName('html')[0];
// htmlDom.style.fontSize=htmlWidth/10 +'px';

// let hT=document.documentElement.clientHeight || document.body.clientHeight;//当前窗口的高度
// console.log(hT);
